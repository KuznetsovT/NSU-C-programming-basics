...
//#include "math.h"
//
///*решение квадратного уравнени€ вида axx + bx + c = 0. ¬озвращает количество решений.
//  ≈сли решений бесконечно много, возвращает -1.
//  «аписывает решение в root1, если оно единственно.
//*/
//int quadratic_equation(const double a, const double b, const double c, double *root1, double *root2);
//
//
//
///*решение уравнени€ вида kx = b. ¬озвращает количество решений.
//  ≈сли решений бесконечно много, возвращает -1.
//  «аписывает решение в х, если оно единственно.
//*/
